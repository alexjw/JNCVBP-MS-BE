...
export const sub_types: CreateSubTypeInput[] = [
  ...
  { name: "Vuelco", code: "10.41" },
  { name: "Caída", code: "10.41" },
  { name: "Aeronave", code: "10.41" },

  { name: "Rescate", code: "10.43" },
  { name: "Recuperación", code: "10.43" },
  { name: "Animales Alimañas", code: "10.43" },
  { name: "Coberturas", code: "10.43" },
  { name: "Curso/Charla", code: "10.43" },
  { name: "Transporte", code: "10.43" },
];
